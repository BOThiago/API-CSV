...
var Command = (function () {
    function Command(options) {
        ...
        this.config = options.config && options.config.mockConfig || options.config instanceof Config_1.Config ? options.config : new Config_1.Config(options.config);
        ...
        this.definition = new ProjectDefinition_1.ProjectDefinitionClass(this.out, this.config);
        this.client = new Client_1.Client(this.config);
        this.auth = new Auth_1.Auth(this.out, this.config, this.client);
        this.env = new Environment_1.Environment(this.out, this.config, this.client);
        this.env.load();
    }
    ...
    Command.mock = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var customArgs, mockDefinition, mockEnv, mockConfig;
            return __generator(this, function (_a) {
                ...
                mockDefinition = customArgs && customArgs.mockDefinition
                    ...
                    : mock.mockDefinition;
                mockEnv = customArgs && customArgs.mockEnv ? customArgs.mockEnv : null;
                ...
                return [2 /*return*/, this.run({ argv: argv, mock: true, mockDefinition: mockDefinition, mockEnv: mockEnv, mockConfig: mockConfig })];
            });
        });
    };
    ...
    Command.prototype.init = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var mockDefinition, mockEnv, parser, _a, argv, flags, args;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mockDefinition = options && options.mockDefinition;
                        mockEnv = options && options.mockEnv;
                        if (mockDefinition) {
