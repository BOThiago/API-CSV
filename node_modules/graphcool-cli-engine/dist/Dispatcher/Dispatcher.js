...
var debug = require('debug')('cli:dispatcher');
var CommandManagerBase = (function () {
...
var BuiltinCommandManager = (function (_super) {
...
var CLICommandManager = (function (_super) {
...
//
var PluginCommandManager = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, plugins.findCommand(id || this.config.defaultCommand || 'help')];
                }
            });
        });
    };
