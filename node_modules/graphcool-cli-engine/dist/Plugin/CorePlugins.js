...
var PluginPath_1 = require("./PluginPath");
var fs = require("fs-extra");
var CorePlugins = (function (_super) {
    __extends(CorePlugins, _super);
     ...
     * @returns {PluginPath[]}
     */
    CorePlugins.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var cli, plugins;
            return __generator(this, function (_a) {
                try {
                    cli = this.config.pjson['cli-engine'];
                    plugins = [];
                    ...
                    if (cli.plugins) {
                        plugins = plugins.concat((cli.plugins || []).map(function (name) {
                            var pluginPath = path.join(_this.config.root, 'node_modules', name);
                            if (!fs.pathExistsSync(pluginPath)) {
                                pluginPath = path.join(_this.config.root, '../../', 'node_modules', name);
                            }
                            return new PluginPath_1.PluginPath({ output: _this.out, type: 'core', path: pluginPath });
                        }));
                    }
                    return [2 /*return*/, plugins];
                }
