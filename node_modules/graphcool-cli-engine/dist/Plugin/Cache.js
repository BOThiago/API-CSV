...
var Cache = (function () {
    ...
    Cache.prototype.deletePlugin = function () {
        ...
        for (var _a = 0, paths_1 = paths; _a < paths_1.length; _a++) {
            ...
            debug("clearing cache for " + pluginPath)(this.constructor).updated = true;
    ...
    Cache.prototype.fetchManagers = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var plugins, lock, downgrade, _i, managers_1, manager, _a, managers_2, manager, paths, _loop_1, this_1, _b, paths_2, pluginPath;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2:
                        if (!(_i < managers_1.length)) return [3 /*break*/, 5];
                    ...
                    case 6:
                        ...
                        _c.label = 7;
                    case 7:
                        _a = 0, managers_2 = managers;
                        _c.label = 8;
                    case 8:
                        if (!(_a < managers_2.length)) return [3 /*break*/, 14];
                        manager = managers_2[_a];
                    ...
                    case 9:
                        ...
                        _c.label = 10;
                    case 10:
                        if (!(_b < paths_2.length)) return [3 /*break*/, 13];
                        pluginPath = paths_2[_b];
