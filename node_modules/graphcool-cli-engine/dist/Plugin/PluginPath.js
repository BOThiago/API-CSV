...
var PluginPath = (function () {
    ...
    PluginPath.prototype.convertToCached = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var plugin, getAliases, commands, topics, _loop_1, _i, commands_1, command, _a, name, version;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { name: name, path: this.path, version: version, commands: commands, topics: topics }];
                }
            });
        });
    };
    ...
    PluginPath.prototype.require = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var required, err_1, exportedTopic, exportedTopics, topics, commands;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, { topics: topics, commands: commands }];
                }
            });
        });
    };
