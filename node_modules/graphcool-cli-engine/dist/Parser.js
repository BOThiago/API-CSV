            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        parseFlag = function (arg) {
                            ...
                            if (flag.parse) {
                                ...
                                var input = (long || arg.length < 3) ? argv.shift() : arg.slice(arg[2] === '=' ? 3 : 2);
                                if (!input) {
                    ...
                    case 1:
                        ...
                        _b = output.flags;
                        _c = name_1;
                        return [4 /*yield*/, flag.parse(['string', 'number', 'boolean'].includes(typeof output.flags[name_1]) ? String(output.flags[name_1]) : undefined, this.input.cmd, name_1)];
                    case 2:
                        _b[_c] = _d.sent();
