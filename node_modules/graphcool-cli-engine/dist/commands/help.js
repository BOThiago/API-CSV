...
function trimToMaxLeft(n) {
    var max = Math.floor(screen_1.stdtermwidth * 0.6);
    return n > max ? max : n;
}
...
function renderList(items) {
    ...
    var maxLeftLength = trimToMaxLeft(max(items, '[0].length')[0].length + 1);
    return items
        .map(function (i) {
        var left = " " + i[0];
        var right = i[1];
...
var Help = (function (_super) {
    ...
    Help.prototype.topics = function (ptopics, id, offset) {
        ...
        var topics = (ptopics || this.plugins.topics).filter(function (t) {
            if (!t.id) {
                return;
            }
