...
var Console = /** @class */ (function (_super) {
    ...
    Console.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var target, foundTarget, projectInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        foundTarget = _a.sent();
                        if (!!this.env.isSharedCluster(foundTarget.cluster)) return [3 /*break*/, 3];
                        ...
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.client.fetchProjectInfo(foundTarget.id)];
                    case 4:
                        projectInfo = _a.sent();
                        opn(util_1.consoleURL(this.env.token, projectInfo.name));
                        _a.label = 5;
    ...
    Console.description = 'Open Graphcool Console in browser';
