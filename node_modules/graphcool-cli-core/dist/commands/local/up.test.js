...
var up_1 = require("./up");
var up_2 = require("./nocks/up");
jest.mock('./Docker');
var Docker = require('./Docker').default;
Docker.mockImplementation(function () {
    return {
        up: function () {
...
describe('up', function () {
    test('in empty dir', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    up_2.default();
                    return [4 /*yield*/, up_1.default.mock()];
                case 1:
                    result = _a.sent();
