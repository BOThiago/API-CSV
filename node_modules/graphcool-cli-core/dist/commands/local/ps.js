...
var PsLocal = /** @class */ (function (_super) {
    __extends(PsLocal, _super);
    function PsLocal() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PsLocal.prototype.run = function () {
    ...
    PsLocal.topic = 'local';
    PsLocal.command = 'ps';
    PsLocal.description = 'List docker containers';
    PsLocal.group = 'local';
    PsLocal.flags = {
