...
var Exporter = /** @class */ (function () {
    ...
    Exporter.prototype.download = function (projectId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.makeDirs();
                        return [4 /*yield*/, this.downloadFiles('nodes', projectId)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.downloadFiles('lists', projectId)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.downloadFiles('relations', projectId)];
                    case 3:
                        _a.sent();
    ...
    Exporter.prototype.downloadFiles = function (fileType, projectId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.download(projectId, JSON.stringify({
                                fileType: fileType,
                                cursor: cursor,
                            }))];
                    case 2:
                        ...
                        if (!data.out || !data.out.jsonElements) {
                            ...
                            this.out.warn("The download of " + fileType + " failed. You may get fragmented data. Request ID: " + data.requestId);
                            return [2 /*return*/];
                        }
