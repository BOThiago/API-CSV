...
var Export = /** @class */ (function (_super) {
    ...
    Export.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var target, exportPath, id, importCommand;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = this.flags.target;
                        exportPath = this.flags['export-path'] || "export-" + new Date().toISOString() + ".zip";
                    ...
                    case 2:
                        id = (_a.sent()).id;
                        return [4 /*yield*/, this.export(id, exportPath)];
                    case 3:
                        _a.sent();
                        importCommand = chalk_1.default.green.bold("$ graphcool import --source " + exportPath + " --target target-name");
    ...
    Export.prototype.export = function (id, exportPath) {
        return __awaiter(this, void 0, void 0, function () {
            var exporter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, exporter.download(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Export.flags = (_a = {
        ...
        _a['export-path'] = graphcool_cli_engine_1.flags.string({
            char: 'e',
