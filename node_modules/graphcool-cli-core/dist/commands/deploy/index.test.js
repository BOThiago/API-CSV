...
describe('deploy', function () {
    test.skip('from empty to default definition', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    default_definition_1.default();
                    return [4 /*yield*/, _1.default.mock({ mockEnv: mockEnv, mockDefinition: graphcool_cli_engine_1.mockDefinition }, '-n', 'servicename', '-c', 'shared-eu-west-1')];
                case 1:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, _1.default.mock({
