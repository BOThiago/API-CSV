...
var Playground = /** @class */ (function (_super) {
    ...
    Playground.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, target, web, id, localPlaygroundPath, url;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.flags, target = _a.target, web = _a.web;
                    ...
                    case 2:
                        ...
                        if (fs.pathExistsSync(localPlaygroundPath) && !web) {
                            url = "graphql-playground://?endpoint=" + this.env.simpleEndpoint(id) + "&platformToken=" + this.env.token + "&cwd=" + process.cwd() + "&env=" + JSON.stringify(process.env);
                            opn(url);
                        }
                        else {
    ...
    Playground.flags = {
        ...
        web: graphcool_cli_engine_1.flags.boolean({
            char: 'w',
